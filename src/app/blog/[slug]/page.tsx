...
export async function generateStaticParams() {
  ...
  if (!Array.isArray(posts)) {
      console.warn('generateStaticParams (blog route): getAllPosts did not return an array, returning empty array for params.');
      return [];
  }
      ...
      <main className="flex-grow container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <Card className="shadow-xl rounded-xl overflow-hidden">
          <CardHeader className="bg-card p-6 sm:p-8">
            <Link href="/blog" className="inline-flex items-center text-sm text-accent hover:underline mb-6 rtl:space-x-reverse">
